...
class AddFragment : Fragment(), AdapterView.OnItemSelectedListener {
    ...
    private fun insertDataToDatabase() {
        ...
        val workSets = slider_value2.text.toString()

        if (inputCheck(workDate, workTime, workName, workReps)) {
            val workout = Workout2(0, workDate, workTime, workName, workReps, workSets)
    ...
    fun sliderFunct2() {
        ...
        slider2.addOnSliderTouchListener(object : Slider.OnSliderTouchListener {
            ...
            override fun onStopTrackingTouch(slider2: Slider) {
                ...
                view!!.slider_value2.text = df.format(value2)
