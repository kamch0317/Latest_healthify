...
class FoodPlanSelectingList : AppCompatActivity() {
    ...
    private fun deletePlan(){
        val intent = Intent(this@FoodPlanSelectingList, DeletePage::class.java)
    ...
    private fun enterPlanDetails(position : Int){
        val intent = Intent(this@FoodPlanSelectingList, FoodDetailsActivity::class.java)
        ...
        intent.putExtra("userName", userName)
        intent.putExtra("id", foodList2[position].id)
        startActivity(intent)
    }

    private fun addNewFoodPlan(){
        val intent = Intent(this@FoodPlanSelectingList, AddNewFoodPlan::class.java)
        intent.putExtra("userName", userName)
        startActivity(intent)
    }
